...
const char INDEX_HTML[] PROGMEM = R"rgbwatt(
<!DOCTYPE html>
...
<body>
  <div class="app">
    ...
    <main class="content">
      ...
      <section class="view" id="view-zones">
        <div class="card" id="powerZoneCard">
          ...
          <div class="field-row">
            <div class="field">
              <label>FTP (W)</label>
              <input type="number" id="ftpInput" data-testid="ftp-input" min="0" max="1000" />
            </div>
            <div class="field">
        ...
        <div class="card" id="hrZoneCard">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input type="number" id="hrMaxInput" data-testid="hr-max-input" min="0" max="230" />
            </div>
            <div class="field">
              <label>Zone Count</label>
      ...
      <!-- SETTINGS -->
      <!-- No manual control-source selector: the active source follows the
           connected device's category automatically (see Devices -> Connect). -->
      ...
      <section class="view" id="view-about">
        <div class="card">
          ...
          <div class="about-rows">
            ...
            <div><span>Firmware build</span><b id="aboutFwBuild" data-testid="about-fw-build">—</b></div>
